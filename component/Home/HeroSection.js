...
export default function HeroSection() {
    ...
    return (
        <div className=' lg:aspect-[8/3] overflow-hidden h-fit'>
            ...
            {/* <div className=' swiper-button-prev absolute bg-blue-400 top-1/2 left-0 transform -translate-y-1/2 cursor-pointer ml-4  h-10 w-10 hover:bg-blue-500 rounded-full flex items-center justify-center hover:text-white transition-all duration-300 ' >
                <FaArrowLeft />
            </div> */}
