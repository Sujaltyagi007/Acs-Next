...
export default function Activity() {
    ...
    const Activities = [
        { bgImage: Activity1, title: "Celebrating Republic Day", color: '#ffdbd2', Img: Bg1 },
        { bgImage: Activity2, title: "Celebrating janmashtami Day", color: '#dff8ff', style: "lg:mt-16 mt-0", Img: Bg2 },
        { bgImage: Activity3, title: "Celebrating Gandhi Jayanti", color: '#ffefdf', style: "lg:mt-16 mt-0", Img: Bg1 },
        { bgImage: Activity4, title: "Celebrating Dussehra Day", color: '#e6f9e5', Img: Bg2 }
    ]
    return (
        <section ref={ref} className='relative overflow-hidden'>
            ...
            <div className="title py-8 px-4">
                ...
                <div className=' w-full flex justify-end' >
                    <Image src={Snale.src} width={500} height={100} alt='apna chhota school' className='' />
                </div>
            </div>
        </section>
    )
