                ...
                <div className=" mx-auto container grid grid-cols-1 md:grid-cols-2 py-10 ">
                    {
                        data.map((item, index) => (
                            <div key={index} className="w-full h-full flex justify-center items-center p-4 text-white  ">
                                <div className=" w-auto h-full bg-[#005c6e] cursor-pointer transition-colors duration-1000 hover:bg-red-500 flex justify-center items-center flex-col gap-4 p-4  "
                                    style={{
                                        clipPath: clipath1,
                                    }}
                                >
                                    ...
                                    <div className=" w-full mx-auto max-w-96 text-center flex flex-col gap-2 justify-between items-center relative ">
                                        ...
                                        <span className=" bg-red-500 rounded-4xl w-fit px-14 py-2  font-bold translate-y-[5%]">
                                            click
                                        </span>
                                    </div>
                                </div>
